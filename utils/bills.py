...
class BillViewer:
    def __init__(self):
        ...
        # Search buttons
        self.bill_no_button = ttk.Button(self.search_frame, text="Search by Bill No.",cursor="hand2",command=self.search_by_bill_no)
        self.bill_no_button.grid(row=0, column=0, padx=10, pady=5)

        self.customer_name_button = ttk.Button(self.search_frame, text="Search by Customer Name",cursor="hand2",command=self.search_by_customer_name)
        self.customer_name_button.grid(row=0, column=1, padx=10, pady=5)

        self.date_range_button = ttk.Button(self.search_frame, text="Search by Date Range",cursor="hand2",command=self.search_by_date_range)
        self.date_range_button.grid(row=0, column=2, padx=10, pady=5)

        self.today_button = ttk.Button(self.search_frame, text="Search Today",cursor="hand2",command=self.search_today)
        self.today_button.grid(row=0, column=3, padx=10, pady=5)

        self.list_all_button = ttk.Button(self.search_frame, text="List All",cursor="hand2", command=self.list_all)
    ...
    def cashmemo_caller(self):
        from .cash_memo import cashmemo
        self.root.destroy()  # Close the current window
        cashmemo()
