...
class Slider:
    def __init__(self, root):
        ...
        try:
            self.image1 = Image.open("assets/images/main_1.jpg")
            self.image2 = Image.open("assets/images/main_2.jpg")
            ...
            # Button images
            self.img1 = ImageTk.PhotoImage(Image.open("assets/images/open_icon.png"))
            self.img2 = ImageTk.PhotoImage(Image.open("assets/images/close_icon.png"))
