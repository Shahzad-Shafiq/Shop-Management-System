...
class BillingApp:
    ...
    def setup_ui(self):
        ...
        ttk.Button(frame, text="Generate PDF", command=self.generate_pdf_bill).grid(row=10, column=4, columnspan=2, padx=5, pady=5,
                                                                      sticky="ew")
    ...
    def generate_pdf_bill(self):
        ...
        filename = f"invoices/{customer_name}_bill.pdf"
